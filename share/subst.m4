...
dnl `logginginterpreter.maude' and `modelchecker.maude'.  These files have
dnl to be processed with dnl m4, with either one of `CREOL', `LOGGING' 
dnl or `MODELCHECK' defined.
dnl
